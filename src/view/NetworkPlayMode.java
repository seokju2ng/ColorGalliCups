...
public class NetworkPlayMode extends JPanel {
	...
	public NetworkPlayMode() {
		...
		// JLabel[]
		keyBoard = new JLabel[] { new JLabel(new ImageIcon("image/red(q).png")),
				new JLabel(new ImageIcon("image/yellow(w).png")), new JLabel(new ImageIcon("image/green(e).png")),
				new JLabel(new ImageIcon("image/blue(a).png")), new JLabel(new ImageIcon("image/black(s).png")) };
